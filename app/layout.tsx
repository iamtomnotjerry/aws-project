            ...
            <footer className="relative py-16 md:py-48 px-4 md:px-6 border-t border-white/[0.05] mt-32 md:mt-64 overflow-hidden">
              ...
              <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24 relative z-10">
                ...
                <div className="md:col-span-3">
                  <h4 className="text-[10px] font-black uppercase tracking-[0.3em] mb-6 md:mb-10 text-primary">Liên kết nhanh</h4>
                ...
                <div className="md:col-span-3">
                  <h4 className="text-[10px] font-black uppercase tracking-[0.3em] mb-6 md:mb-10 text-primary">Lan tỏa giá trị</h4>
                  <div className="flex gap-4">
                    <Magnetic strength={0.3}>
                      <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-primary/20 hover:text-primary transition-all duration-500 cursor-pointer">
                    ...
                    <Magnetic strength={0.3}>
                      <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-white hover:text-black transition-all duration-500 cursor-pointer">
