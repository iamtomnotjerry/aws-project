    ...
    <div className="min-h-screen pb-48">
      ...
      <section className="relative pt-12 md:pt-24 pb-16 md:pb-24 px-4 md:px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            <div className="mb-2 md:mb-4">TỐI ƯU</div>
            <div className="mt-4 md:mt-8">
              <span className="text-gradient not-italic">HỆ THỐNG.</span>
            </div>
          </motion.h1>
          ...
          >
            Dữ liệu được Server-Side Rendering (RSC) kết hợp Redis Cache siêu tốc. Trải nghiệm tức thì.
          </motion.p>
        </div>
      </section>
